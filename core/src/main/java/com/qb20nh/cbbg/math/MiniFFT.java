...
public class MiniFFT {
  ...
  private static void processXAxis(
      double[] real, double[] imag, int w, int h, int d, boolean inverse) {
  ...
  private static void processYAxis(
      double[] real, double[] imag, int w, int h, int d, boolean inverse) {
  ...
  private static void processZAxis(
      double[] real, double[] imag, int w, int h, int d, boolean inverse) {
