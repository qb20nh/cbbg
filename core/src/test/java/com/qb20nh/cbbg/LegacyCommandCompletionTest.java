...
class LegacyCommandCompletionTest {
    ...
    void notificationCompletionFollowsNativeToastAvailability() {
        assertEquals(Arrays.asList("chat"),
                LegacyCommandGrammar.suggest("/cbbg notification ", false));
        assertEquals(Arrays.asList("chat", "toast"),
                LegacyCommandGrammar.suggest("/cbbg notification ", true));
    ...
    void precisionCompletionExcludesFallbackFormatAndFiltersPrefix() {
        ...
        assertEquals(Arrays.asList("rgba32f"),
                LegacyCommandGrammar.suggest("/cbbg format set RGBA3", true));
    }
}
