      ...
      context.runOnClient(
          client -> {
            var old =
                fixture
                    .pass
                    .render(fixture.source.getColorTextureView(), fixture.view, 1, 1, 1, false)
                    .getColorTexture();
            var small =
                new TextureTarget("CBBG resize fixture", 3, 2, GpuFormat.RGBA32_FLOAT, null);
            try {
              var resized =
                  fixture.pass.render(small.getColorTextureView(), fixture.view, 1, 1, 1, false);
  ...
  private static void check(
    ...
    context.runOnClient(
        client -> {
          var output =
              fixture.pass.render(
                  fixture.source.getColorTextureView(), fixture.view, strength, scale, scale, demo);
