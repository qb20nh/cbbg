...
public final class DitherPass implements AutoCloseable {
    ...
    private static RenderPipeline pipeline(boolean demo) {
        var builder = RenderPipeline.builder()
                .withLocation(Identifier.fromNamespaceAndPath("cbbg", demo ? "pipeline/demo" : "pipeline/dither"))
                ...
                .withBindGroupLayout(BindGroupLayout.builder()
                        ...
                        .withUniform("CbbgDitherInfo", UniformType.UNIFORM_BUFFER).build())
    ...
    public TextureTarget render(GpuTextureView input, GpuTextureView noise, float strength,
            float scaleX, float scaleY, boolean demo) {
        ...
        try (RenderPass pass = encoder.createRenderPass(() -> "CBBG dither",
            ...
            pass.setUniform("NoiseSampler", noise,
