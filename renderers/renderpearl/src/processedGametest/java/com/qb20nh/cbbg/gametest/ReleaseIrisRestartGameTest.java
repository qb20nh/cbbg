...
public final class ReleaseIrisRestartGameTest implements FabricClientGameTest {
    ...
    public void runTest(ClientGameTestContext context) {
        ...
        try (var world = context.worldBuilder().create()) {
            ...
            if (!phase.equals("verify")) {
                ReleaseClient.command(context, "mode set " + (phase.equals("control") ? "disabled" : "enabled"));
            ...
            context.runOnClient(client -> {
                ...
                ReleaseIrisGameTest.checkDebug(client, phase.equals("control") ? "DISABLED" : "ENABLED", true);
            });
