...
public final class ReleaseStartupPreLaunch implements PreLaunchEntrypoint {
    ...
    public void onPreLaunch() {
        ...
        long preLaunchWorkers = Thread.getAllStackTraces().keySet().stream()
        ...
        try {
            ...
            Files.writeString(evidence.resolve("startup-prelaunch.json"),
                    "{\"preLaunchMillis\":" + preLaunchMillis
                            + ",\"preLaunchWorkers\":" + preLaunchWorkers + "}\n");
