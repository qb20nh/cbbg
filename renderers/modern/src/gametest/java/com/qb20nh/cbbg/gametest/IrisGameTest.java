...
public final class IrisGameTest implements FabricClientGameTest {
  ...
  public void runTest(ClientGameTestContext context) {
    ...
    float originalScale =
        context.computeOnClient(
            client ->
                RenderScaleCompat.isLoaded() ? RenderScaleTestAccess.setShaderTestScale(0.5f) : 1);
            ...
            Screenshot.takeScreenshot(
                ...
                image -> {
                  try (image) {
                    ...
                    image.writeToFile(
                        evidence.resolve(
                            "iris-active-" + System.getProperty("cbbg.test.backend") + ".png"));
  ...
  private static void checkDebug(
      net.minecraft.client.Minecraft client, CbbgConfig.Mode user, boolean active) {
