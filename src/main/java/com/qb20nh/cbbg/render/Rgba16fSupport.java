 ...
 *
 * <p>
 * If we detect an OpenGL error allocating the main target as RGBA16F, we fall back to vanilla RGBA8
 * for the remainder of the session to avoid hard-crashes.
 */
