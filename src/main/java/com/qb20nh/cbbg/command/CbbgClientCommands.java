...
public final class CbbgClientCommands {
    ...
    public static void register() {
        ClientCommandRegistrationCallback.EVENT.register((dispatcher,
                registryAccess) -> dispatcher.register(literal("cbbg")
                        .then(literal("mode")
                                .executes(context -> {
                                ...
                                .then(literal("set")
                                        .then(argument("mode", StringArgumentType.string())
                                                ...
                                                .executes(context -> {
                                                    ...
                                                    try {
                                                        CbbgConfig.Mode mode = CbbgConfig.Mode
                                                                .valueOf(modeName.toUpperCase());
                                                        ...
                                                        context.getSource().sendError(
                                                                Component.literal("Invalid mode: " + modeName));
                                                        return 0;
                                                    }
                                                }))))));
    }
