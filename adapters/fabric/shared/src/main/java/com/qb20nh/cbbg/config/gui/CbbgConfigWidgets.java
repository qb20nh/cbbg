...
final class CbbgConfigWidgets {
  ...
  CbbgConfigWidgets(
      ...
      int width,
      int height,
      boolean lockedByError,
      Runnable confirmGeneration,
      Runnable close) {
  ...
  void init() {
    ...
    CycleButton<CbbgConfig.Mode> modeButton =
        this.add(
            WidgetPlatform.cycleTooltip(
                    WidgetPlatform.cycle(
                        this::getModeName, CbbgConfig.get().mode(), CbbgConfig.Mode.values()),
                    this::getModeTooltip)
                .create(
                    cx - 100,
                    yStart,
                    200,
                    20,
                    Text.translatable("cbbg.config.mode"),
                    (button, value) -> {
    ...
    CycleButton<CbbgConfig.PixelFormat> formatButton =
        this.add(
            WidgetPlatform.cycle(
                    CbbgConfigWidgets::getPixelFormatName,
    ...
    FloatSlider strengthSlider =
        new FloatSlider(
            ...
            200,
            20,
            Text.translatable("cbbg.config.strength.label"),
            0.5f,
            4.0f,
    ...
    PowerOfTwoSlider sizeSlider =
        new PowerOfTwoSlider(
            ...
            98,
            20,
            Text.translatable("cbbg.config.size.label"),
            16,
            256,
    ...
    PowerOfTwoSlider depthSlider =
        new PowerOfTwoSlider(
            ...
            98,
            20,
            Text.translatable("cbbg.config.depth.label"),
            8,
            128,
    ...
    this.add(
        WidgetPlatform.button(
            Text.translatable("cbbg.config.button.done"),
            b -> close.run(),
            cx - 100,
            y,
            200,
