...
public final class CbbgConfigScreen extends Screen {
  ...
  private static final Tooltip TOOLTIP_STRENGTH =
      Tooltip.create(Component.translatable("cbbg.config.tooltip.strength"));
  private static final Tooltip TOOLTIP_STBN_SIZE =
      Tooltip.create(Component.translatable("cbbg.config.tooltip.stbn_size"));
  private static final Tooltip TOOLTIP_STBN_DEPTH =
      Tooltip.create(Component.translatable("cbbg.config.tooltip.stbn_depth"));
  private static final Tooltip TOOLTIP_STBN_SEED =
      Tooltip.create(Component.translatable("cbbg.config.tooltip.stbn_seed"));
  ...
  protected void init() {
    ...
    CycleButton<CbbgConfig.Mode> modeButton =
        this.addRenderableWidget(
            CycleButton.builder(this::getModeName, CbbgConfig.get().mode())
                .withTooltip(this::getModeTooltip)
                .withValues(CbbgConfig.Mode.values())
                .create(
                    cx - 100,
                    yStart,
                    200,
                    20,
                    Component.translatable("cbbg.config.mode"),
                    (_, value) -> {
    ...
    CycleButton<CbbgConfig.PixelFormat> formatButton =
        this.addRenderableWidget(
            CycleButton.builder(
                    CbbgConfigScreen::getPixelFormatName, CbbgConfig.get().pixelFormat())
    ...
    FloatSlider strengthSlider =
        new FloatSlider(
            ...
            200,
            20,
            Component.translatable("cbbg.config.strength.label"),
            0.5f,
            4.0f,
    ...
    PowerOfTwoSlider sizeSlider =
        new PowerOfTwoSlider(
            cx - 100,
            y,
            98,
            20,
            Component.translatable("cbbg.config.size.label"),
            16,
            256,
    ...
    PowerOfTwoSlider depthSlider =
        new PowerOfTwoSlider(
            ...
            98,
            20,
            Component.translatable("cbbg.config.depth.label"),
            8,
            128,
    ...
    seedEdit =
        new EditBox(
            this.font, cx - 100 + 40, y, 160, 20, Component.translatable("cbbg.config.seed.label"));
    ...
    CycleButton<Boolean> chatNotifyButton =
        this.addRenderableWidget(
            CycleButton.onOffBuilder(CbbgConfig.get().notifyChat())
                .create(
                    cx - 100,
                    y,
                    98,
    ...
    CycleButton<Boolean> toastNotifyButton =
        this.addRenderableWidget(
            CycleButton.onOffBuilder(CbbgConfig.get().notifyToast())
                .create(
                    cx + 2,
                    y,
                    98,
    ...
    // 8. Done Button
    this.addRenderableWidget(
        Button.builder(Component.translatable("cbbg.config.button.done"), _ -> this.onClose())
            .bounds(cx - 100, y, 200, 20)
            .build());
  ...
  private static class PowerOfTwoSlider extends AbstractSliderButton {
    ...
    protected void updateMessage() {
      ...
      this.setMessage(
          Component.translatable(
              "cbbg.config.labeled_value", label, Objects.requireNonNull(Integer.toString(val))));
    }
