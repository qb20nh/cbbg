 ...
 *
 * <p>RenderScale renders the world into its own {@code TextureTarget} labelled {@code
 * "RenderScale"} and then blits that back into Minecraft's main render target. To avoid early
