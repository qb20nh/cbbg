...
public final class CbbgClientCommands {
  ...
  public static void register() {
    ClientCommandRegistrationCallback.EVENT.register(
        (dispatcher, _) -> registerCommands(dispatcher));
  }
                                ...
                                ctx.getSource()
                                    .sendFeedback(
                                        Component.translatable(
                                            "cbbg.command.mode.set", modeName(mode)));
                                return 1;
                              } catch (Exception e) {
                                ctx.getSource()
                                    .sendError(
                                        Component.translatable(
                                            "cbbg.command.mode.invalid", modeName));
                                sendModeUsage(ctx.getSource());
                                return 0;
                              }
                            })));
        ...
        .executes(
            ctx -> {
              ...
              ctx.getSource()
                  .sendFeedback(
                      Component.translatable(
                          "cbbg.command.format.current", pixelFormatName(format)));
              return 1;
            })
        .then(
            literal("set")
                            ...
                            ctx -> {
                              ...
                              try {
                                ...
                                ctx.getSource()
                                    .sendError(
                                        Component.translatable(
                                            "cbbg.command.format.invalid", fmtName));
        ...
        .then(
            literal("generate")
                .executes(
                    ctx -> {
                      ctx.getSource()
                          .sendFeedback(Component.translatable("cbbg.command.stbn.generating"));
                            ...
                            ctx -> {
                              ...
                              if (Integer.bitCount(size) != 1) { // Check power of two
                                ctx.getSource()
                                    .sendError(
                                        Component.translatable(
                                            "cbbg.command.stbn.size.invalid_pow2"));
                                sendStbnSizeUsage(ctx.getSource());
                                return 0;
                              }
                              ...
                              ctx.getSource()
                                  .sendFeedback(
                                      Component.translatable("cbbg.command.stbn.size.set", size));
                              return 1;
                            })))
        .then(
            literal("depth")
                            ...
                            ctx -> {
                              ...
                              if (Integer.bitCount(depth) != 1) {
                                ctx.getSource()
                                    .sendError(
                                        Component.translatable(
                                            "cbbg.command.stbn.depth.invalid_pow2"));
                                sendStbnDepthUsage(ctx.getSource());
                                return 0;
                              }
                              ...
                              ctx.getSource()
                                  .sendFeedback(
                                      Component.translatable("cbbg.command.stbn.depth.set", depth));
                              return 1;
                            })))
        .then(
            literal("seed")
                    ...
                    argument(ARG_VALUE, STBN_SEED_ARG)
                        .executes(
                            ctx -> {
                              ...
                              ctx.getSource()
                                  .sendFeedback(
                                      Component.translatable("cbbg.command.stbn.seed.set", seed));
                              return 1;
                            })))
        .then(
            literal("reset")
                .executes(
                    ctx -> {
                      ...
                      ctx.getSource()
                          .sendFeedback(Component.translatable("cbbg.command.stbn.reset"));
                      return 1;
                    }));
  }
                        ...
                        .executes(
                            ctx -> {
                              ...
                              ctx.getSource()
                                  .sendFeedback(
                                      Component.translatable(
                                          "cbbg.command.notification.chat.current", val));
                              return 1;
                            })))
        .then(
            literal("toast")
  ...
  private static void sendStbnSizeUsage(FabricClientCommandSource source) {
    source.sendFeedback(
        Component.translatable("cbbg.command.stbn.size.current", CbbgConfig.get().stbnSize()));
  ...
  private static void sendStbnDepthUsage(FabricClientCommandSource source) {
    source.sendFeedback(
        Component.translatable("cbbg.command.stbn.depth.current", CbbgConfig.get().stbnDepth()));
  ...
  private static void sendStbnSeedUsage(FabricClientCommandSource source) {
    source.sendFeedback(
        Component.translatable("cbbg.command.stbn.seed.current", CbbgConfig.get().stbnSeed()));
