...
class CbbgConfigScreenTest {
  ...
  void seedInput_acceptsSignedLongsAndEmptyDefault() {
    ...
    Assertions.assertEquals(Long.MIN_VALUE, CbbgConfigScreen.parseSeed("-9223372036854775808"));
    Assertions.assertEquals(Long.MAX_VALUE, CbbgConfigScreen.parseSeed("9223372036854775807"));
  }
  ...
  void seedInput_rejectsMalformedAndOverflowingValues() {
    for (String text :
        new String[] {
          "abc", "1-2", "--1", "-", "+1", " 1", "1.5", "9223372036854775808", "-9223372036854775809"
        }) {
      Assertions.assertThrows(
          NumberFormatException.class, () -> CbbgConfigScreen.parseSeed(text), text);
    }
  }
  ...
  void powerOfTwoSlider_mapsToPowersOfTwo() throws Exception {
    Class<?> sliderClass =
        Class.forName("com.qb20nh.cbbg.config.gui.CbbgConfigScreen$PowerOfTwoSlider");
    Constructor<?> ctor =
        sliderClass.getDeclaredConstructor(
            int.class,
            int.class,
            int.class,
            int.class,
    ...
    Object slider =
        ctor.newInstance(
            0, 0, 100, 20, Component.literal("Size: "), 16, 256, 128, (IntConsumer) lastSet::set);
  ...
  void floatSlider_clampsInputAndFormatsTwoDecimals() throws Exception {
    Class<?> sliderClass = Class.forName("com.qb20nh.cbbg.config.gui.CbbgConfigScreen$FloatSlider");
    Constructor<?> ctor =
        sliderClass.getDeclaredConstructor(
            int.class,
            int.class,
